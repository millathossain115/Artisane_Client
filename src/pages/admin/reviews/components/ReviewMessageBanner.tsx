...
import type { AdminReviewMessage } from '../reviewAdminUtils'

type ReviewMessageBannerProps = {
  message: AdminReviewMessage
  onClose: () => void
}

function ReviewMessageBanner({ message, onClose }: ReviewMessageBannerProps) {
  return (
    <div
...
export default ReviewMessageBanner
