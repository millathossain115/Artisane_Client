...
import type { AdminOrderMessage } from '../orderAdminUtils'

type OrderMessageBannerProps = {
  message: AdminOrderMessage
  onClose: () => void
}

function OrderMessageBanner({ message, onClose }: OrderMessageBannerProps) {
  return (
    <div
...
export default OrderMessageBanner
