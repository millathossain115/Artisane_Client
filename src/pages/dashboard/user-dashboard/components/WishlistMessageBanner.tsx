...
import type { WishlistMessage } from '../wishlistUtils'

type WishlistMessageBannerProps = {
  message: WishlistMessage
  onClose: () => void
}

function WishlistMessageBanner({
  message,
  onClose,
}: WishlistMessageBannerProps) {
  return (
    <div
...
export default WishlistMessageBanner
