...
function ProductTile({ product, tone = 'light', variant = 'default' }: {
  product: Product
  tone?: 'dark' | 'light'
          ...
          <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-5 max-w-lg text-sm leading-7 text-[#6b5f53]">
                Paint, textile, clay, jewelry, and storage products are stocked
                so shoppers can build a complete cart from one home page.
              </p>
              <a
